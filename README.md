...
|---|---|---|---|
| [Impact of SMS Reminders on No-Shows](https://github.com/qetate/SMSRemindersAndNoShows) | Python, Pandas, NumPy, Matplotlib, Seaborn, Scikit-learn | Data Wrangling, Data Cleaning, Data Visualization, EDA, Statistical Analysis, Machine Learning | This project seeks to answer the research question: Does sending SMS appointment reminders to patients reduce the number of no-show appointments? |
| [Sparkify Database](https://github.com/qetate/SparkifyDatabase) | Python, PostgreSQL | Database Operations, Data Cleaning, Data Transformation, Data Visualization | This project involves designing and implementing ETL (Extract, Transform, Load) processes for the Sparkify database, a data warehouse designed to store and analyze song and log data from a music streaming application. |
| [Explore Bike Share Data](https://github.com/qetate/ExploreBikeShareData) | R, ggplot2, dplyr | Data Analysis, Data Manipulation, Data Visualization | This project involves analyzing bike share data from three major cities: New York City, Washington, and Chicago. |
| [Finding Donors (Supervised Learning) ](https://github.com/qetate/FindingDonors-MachineLearning) | Python, Scikit-learn | Machine Learning, Model Tuning, Benchmarking | This machine learning project involves evaluating and optimizing various algorithms to predict whether individuals make more than $50,000 based on census data. |
...
| [Identifying Customer Segments](https://github.com/qetate/IdentifyCustomerSegments-MachineLearning) | Python, Pandas, NumPy, Matplotlib, Seaborn, Scikit-learn | Unsupervised Learning Models, Cluster Analysis, Data Preprocessing | This machine learning project involves using unsupervised learning techniques to identify distinct customer segments from demographic data. |
| [Income Prediction Model](https://github.com/qetate/IncomePredictionModel) | Python, FastAPI, Scikit-learn | Supervised Learning Models, API Development, Model Evaluation | This project focuses on developing a classification model to predict whether an individual's income is above or below $50,000 using census data. |
| [ML Pipeline for Short-Term Rental Prices in NYC](https://github.com/qetate/MLPipeline-NYCRentals) | Python, Conda, Scikit-learn, Weights & Biases | Pipeline Automation, Hyperparameter Tuning, Experiment Tracking, Model Evaluation & Deployment | This project involves building an end-to-end machine learning pipeline to estimate short-term rental prices in NYC. |
